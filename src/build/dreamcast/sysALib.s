 ...
 * To be included in the Real VMX distribution.
 * Original KallistiOS is BSD License.
 * Real VMX is GNU public license.
 */
...
#include "config.h"
	...
	.globl	_sysInit
	.globl	GTEXT(sysExit)
	.globl	GTEXT(sysOldSR)
	.globl	GTEXT(sysOldVBR)
	.globl	GTEXT(sysOldSP)
	.globl	GTEXT(sysOldFPSCR)
